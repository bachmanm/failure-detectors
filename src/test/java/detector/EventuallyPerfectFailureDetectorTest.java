...
/**
 * Unit tests for {@link detector.EventuallyPerfectFailureDetector}.
 */
public class EventuallyPerfectFailureDetectorTest {
    ...
    public void createDetector() {
        ...
        detector = new EventuallyPerfectFailureDetector(mockProcess);
    }
