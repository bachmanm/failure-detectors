...
/**
 * Utility class for sorting a map by descending value. Used for finding majority votes.
 */
public final class MapSorter {
    ...
    public static <K, V extends Comparable<V>> SortedMap<K, V> sortMapByDescendingValue(Map<K, V> map) {
        SortedMap<K, V> sortedMap = new TreeMap<K, V>(new MapValueDescComparator<K, V>(map));
